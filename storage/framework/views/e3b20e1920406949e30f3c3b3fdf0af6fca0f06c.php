...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="<?php echo e(url('admin/info')); ?>">首頁</a> &raquo; 文章管理
</div>
<!--面包屑导航 结束-->
...
//                                    alert(data);
            ...
            <tr>
                <th></th>
                <td>
                    <img alt="" id="art_thumb_img" style="max-width: 350px; max-height:100px;" src="/laravelcode/blog/<?php echo e($field->art_thumb); ?>">
                </td>
            </tr>
            <tr>
                <th>關鍵詞：</th>
