...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首頁</a> &raquo; 鏈結管理
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{url('admin/links/create')}}"><i class="fa fa-plus"></i>添加鏈結</a>
                    <a href="{{url('admin/links')}}"><i class="fa fa-recycle"></i>全部鏈結</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
